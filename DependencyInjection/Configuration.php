...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('wrep_tcpdf');
            ...
            ->children()
                ->arrayNode('tcpdf')
                    ...
                    ->children()
                        ...
                        ->scalarNode('k_path_cache')->defaultValue('%kernel.cache_dir%/tcpdf/tcpdf')->end()
                        ->scalarNode('k_path_url_cache')->defaultValue('%kernel.cache_dir%/tcpdf/tcpdf')->end()
